            ...
            "runs": [
                {
                    "tool": {
                        "driver": {
                            "name": "Barzakh Scanner",
                            "version": "1.0.0",
                            "informationUri": "https://github.com/barzakh/scanner",
...
<head>
    ...
    <title>Barzakh Scanner Report</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ Barzakh Scanner Report</h1>
...
"""
        ...
        <div class="footer">
            <p>Barzakh Scanner v1.0 | Academic Research Project</p>
            <p>Copyright © 2026 Barzakh Research Project</p>
        </div>
    </div>
</body>
</html>
...
*Barzakh Scanner - Academic Research Project*  
*Copyright © 2026 Barzakh Research Project*
"""
